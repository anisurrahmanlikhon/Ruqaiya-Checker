...
function submitQuiz() {
    ...
    if (diseaseProbability === 1) {
        resultText = "যেকোন রোগে আক্রান্ত হওয়ার সম্ভাবনা: 100%";
    } else if (diseaseProbability === 0) {
        resultText = "যেকোন রোগে আক্রান্ত হওয়ার সম্ভাবনা: 0%";
    } else {
        resultText = `যেকোন রোগে আক্রান্ত হওয়ার সম্ভাবনা: ${(diseaseProbability * 100).toFixed(0)}%`;
    }
